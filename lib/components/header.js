...
var NodeHeader = function (_Component) {
    (0, _inherits3.default)(NodeHeader, _Component);
    ...
    (0, _createClass3.default)(NodeHeader, [{
        ...
        value: function render() {
            ...
            var activeLink = active ? style.activeLink : null;
            var headerStyles = (0, _assign2.default)({}, style, style.link, activeLink);

            return _react2.default.createElement(decorators.Container, (0, _extends3.default)({ animations: animations, decorators: decorators, node: node, onClick: onClick, terminal: terminal }, {
                style: headerStyles
            }));
        }
    }]);
